...
import '../language_side/view.dart';

class EducationSideScreen extends StatelessWidget {
  const EducationSideScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        const ItemButtonWidget(text: 'NEXT', nextPage: LanguageSideScreen()),
      ]),
    )));
  }
}
