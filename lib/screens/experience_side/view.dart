...
import '../certificates_side/view.dart';

class ExperienceSideScreen extends StatelessWidget {
  const ExperienceSideScreen({Key? key}) : super(key: key);
      ...
      body: SafeArea(
        child: Padding(
          ...
          child:
            ...
            const ItemButtonWidget(text: 'NEXT', nextPage: CertificatesSideScreen()),
          ]),
        ),
      ),
    );
